...
def table():
    ...
    with con:
        ...
        for row in resultIDs:
            ...
            for row1 in playTimeResults:
                data.append(Player(row[0],row[1],row[2],row[3],row[4],row[5],row[6],row[7],row[8],row[9],row[10],row[11]))
    ...
    positions = ['Pitcher', 'Catcher', 'First Base Man', 'Second Base Man', 'Third Base Man', 'Short Stop', 'Left Fielder'
